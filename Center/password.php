  ...
  <body class="bg-dark body" style="padding-top:13%;">
    ...
    <div class="container">
      <form method="post" action="changepassword.php" class="col">
          <div class="row">
            <input class="form-control" type="password" name="password" placeholder="Votre mdp" autocomplete="off">
          </div>
          <br>
          <div class="row">
            <input class="form-control" type="password" name="new" placeholder="Nouveau mdp" autocomplete="off">
          </div>
          <br>
          <div class="row">
            <input class="form-control" type="password" name="check" placeholder="Confirmez le nouveau mdp" autocomplete="off">
          </div>
          <br>
          <div class="row">
