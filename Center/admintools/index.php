    ...
    <main>
      <div class="row contenu1">
        ...
        <div class="col-md-5 col-sm-12 col-xs-9 bg-dark">
          ...
          <button type= "button" class="vague btn btn-info btn-lg button2 text-white fs-4 text-uppercase fw-bold" onclick="window.location.href='promoteuser.php'"> PROMOUVOIR UN UTILISATEUR </button>

          <button type="button" class="vague btn btn-success btn-lg button2 text-white fs-4 text-uppercase fw-bold" onclick="window.location.href='allusers.php'"> LISTE DES UTILISATEURS </button>

          <button type="button" class="vague btn btn-danger btn-lg button2 text-white fs-4 text-uppercase fw-bold" onclick="window.location.href='deleteuser.php'"> SUPPRIMER UN UTILISATEUR </button>

          <button type="button" class="vague btn btn-warning btn-lg button2 text-white fs-4 text-uppercase fw-bold" onclick="window.location.href='addmusique.php'"> Ajouter des musiques </button>

          <button type="button" class="vague btn btn-info btn-lg button2 text-white fs-4 text-uppercase fw-bold" onclick="window.location.href='map.php'"> Geolocalisation </button>
              ...
              <div class="modal-body">
                ...
                <form action="create.php" method="post">
                  ...
                  <div onclick="changement()">
                    ...
                    <button class="btn btn-lg btn-dark" onclick="window.location.href=#"> Clixk </button>
